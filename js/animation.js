...
const config = {
    name: "My Specially person", // actual name of the recipient (Mandatory)

    nickname: "Frdls", // nickname(optional)
...
button.addEventListener("click",function(){
    ...
    if(button.classList.contains("switch")) {
        ...
        */
        ...
        document.querySelector(".HBD").textContent = "HAPPY BIRTHDAY FOR YOU";
